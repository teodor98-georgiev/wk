...
def cost_shipping(cargoWeight,distance):
    ...
    if cargoWeight <= 100.5 or distance <= 1000.5:
        ...
        cost_travel += cargoWeight*9 + distance*10
...
# ZDR DONE make text formatting not to repeat but to happen at the end of the function  
# ZDR oprosti oshte, pomisli kak
